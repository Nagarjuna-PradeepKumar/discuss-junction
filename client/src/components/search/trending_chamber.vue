<template>
  ...
  <v-container v-else>
    ...
    <v-card class="transparent" elevation="0">
      <v-row justify="center">
        <v-col v-for="(chamber,i) in trending_chambers" :key="i" cols="12" sm="6">
          <v-hover v-slot:default="{ hover }">
            ...
            >
              <v-container class="mb-0 pb-0">
                ...
                <v-row class="pb-0 mb-0" style="position:relative;top:0">
                  <v-btn
                    block
                    color="#1D1D1D"
                    class="white--text"
...
export default {
  ...
  mounted() {
    this.$axios
      ...
      .then(Response => {
        if (Response.data.success) {
          this.trending_chambers = Response.data.success.chamberdatas;
          this.total_items = Response.data.success.totalcount.totaldocs;
    ...
    this.$emit("settab", { id: 1, name: "trending_chamber" });
  },
  watch: {
